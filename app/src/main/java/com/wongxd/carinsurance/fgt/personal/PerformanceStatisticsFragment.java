...
public class PerformanceStatisticsFragment extends LazyLoadFragment {
    @BindView(R.id.rv)
    XRecyclerView rv;
    ...
    protected void lazyLoad() {
        ...
        rv.setAdapter(new RvDataAnalysisAdapter(getActivity(), list, RvDataAnalysisAdapter.ITEM_TYPE.ITEM_FOUR_2));
     ...
     * @return 包含参数的fgt实例
     */
    public static PerformanceStatisticsFragment getInstance(@Nullable Bundle args) {
        PerformanceStatisticsFragment fragment = new PerformanceStatisticsFragment();
        if (null != args) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvName.setText("保险公司");
        tvItem1.setText("交强险(元)");
        tvItem2.setText("商业险(元)");
        tvItem3.setText("业绩(元)");
