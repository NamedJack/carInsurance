...
import com.wongxd.carinsurance.fgt.personal.PerformanceStatisticsFragment;
...
public class PerformanceStatisticsActivity extends BaseSwipeActivity {
    ...
    private void init(List<Fragment> fgtList) {
        ...
        for (int i = 0; i < dateList.size(); i++) {
            ...
            fgtList.add(PerformanceStatisticsFragment.getInstance(b));
        }
