...
import com.wongxd.carinsurance.fgt.personal.PolicyAnalysisFragment;
...
public class PolicyAnalysisActivity extends BaseSwipeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_policy_analysis);
    ...
    private void init(List<Fragment> fgtList) {
        ...
        for (int i = 0; i < dateList.size(); i++) {
            ...
            fgtList.add(PolicyAnalysisFragment.getInstance(b));
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_date:
                ...
                PopwindowMenu.datePopWindow(thisActivity, tvDate, dateList, new PopwindowMenu.PopMenuCallBack() {
                            @Override
                            public void selectedItemChange(String str, int position, String id) {
